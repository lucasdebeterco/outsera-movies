...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
      <div className="flex h-screen flex-col items-center w-full text-primary-text  font-sans ">
        ...
        <main className="flex w-full items-center justify-between sm:items-start">
          <nav className='bg-secondary-light w-full h-[calc(100vh-50px)] flex flex-col max-w-3xs p-4 gap-2'>
